...
def reading_sheet_config_data_to_dict(sheet_name):
    try:
        ...
        work_book = openpyxl.load_workbook(
            r"C:\Users\BRADSOL-User\Documents\GitHub\brad-lnco-projects\Lnco\Input\Config_windows.xlsx")
        work_sheet = work_book[sheet_name]
        maximum_row = work_sheet.max_row
        maximum_col = work_sheet.max_column
...
def process_execution(input_files):
    ...
    purchase_register_file_path = input_files[2]
    ...
    try:
        ...
        print(os.path.isfile(purchase_register_file_path))
        print(purchase_register_file_path)
        read_present_quarter_pd = pd.read_excel(purchase_register_file_path,
        ...
        read_previous_quarter_pd = pd.read_excel(purchase_register_file_path,
    ...
    try:
        ...
        ptcomp.create_purchase_type_wise(config_main, config_purchase_comparatives, read_present_quarter_pd,
    ...
    try:
        ...
        pwcomp.create_plant_wise_sheet(config_main, config_plant_comparatives, read_present_quarter_pd,
                                       read_previous_quarter_pd)
    ...
    try:
        ...
        duplication.vendor_numbers_duplication(config_main, config_duplication, vendor_file_path)
    ...
    try:
        ...
        im.create_Inventory_Mapping_sheet(config_main, config_Inventory_mapping, read_present_quarter_pd, mb51_file_path)
