...
def sales_previous_quarter_file_creation(sales_previous_client_dataframe, json_data_list,
    ...
    try:
        ...
        purchase_previous_new_dataframe[plant_default_name] = sales_previous_client_dataframe[plant_client_name]
        ...
        purchase_previous_new_dataframe[gr_document_number_default_name] = sales_previous_client_dataframe[
        ...
        purchase_previous_new_dataframe[gr_posting_date_default_name] = sales_previous_client_dataframe[
        ...
        purchase_previous_new_dataframe[valuation_class_default_name] = sales_previous_client_dataframe[
        ...
        purchase_previous_new_dataframe[valuation_class_text_default_name] = sales_previous_client_dataframe[
        ...
        purchase_previous_new_dataframe[material_number_default_name] = sales_previous_client_dataframe[
        ...
        purchase_previous_new_dataframe[material_description_default_name] = sales_previous_client_dataframe[
        ...
        purchase_previous_new_dataframe[vendor_number_default_name] = sales_previous_client_dataframe[
        ...
        purchase_previous_new_dataframe[vendor_name_default_name] = sales_previous_client_dataframe[
        ...
        purchase_previous_new_dataframe[gr_quantity_default_name] = sales_previous_client_dataframe[
        ...
        purchase_previous_new_dataframe[gr_amount_in_loc_cur_default_name] = sales_previous_client_dataframe[
        ...
        purchase_previous_new_dataframe[unit_price_default_name] = sales_previous_client_dataframe[
        ...
        purchase_previous_new_dataframe[currency_key_default_name] = sales_previous_client_dataframe[
            currency_key_client_name]

        # print(purchase_previous_new_dataframe.dtypes)
        # print(purchase_previous_client_dataframe.dtypes)
    ...
    try:
        purchase_previous_new_dataframe.columns = ['Plant', 'GR Document Number', 'GR Posting Date',
        ...
        purchase_previous_new_dataframe[["Plant", "GR Document Number", "Valuation Class"]] = \
            purchase_previous_new_dataframe[["Plant", "GR Document Number", "Valuation Class"]].fillna(
        ...
        purchase_previous_new_dataframe[["Valuation Class Text", "Material No.", "Material Desc", "Currency Key"]] = \
            purchase_previous_new_dataframe[
                ["Valuation Class Text", "Material No.", "Material Desc", "Currency Key"]].astype(str, errors='raise')

        # purchase_previous_new_dataframe[["GR Posting Date"]] = purchase_previous_new_dataframe[["GR Posting Date"]].apply(pd.to_datetime)

        # vendor number - int datatype and can have nan values replace them with ''
        purchase_previous_new_dataframe[["Vendor No."]] = purchase_previous_new_dataframe[["Vendor No."]].fillna(
            '').astype(int, errors='ignore')
        # vendor number - string datatype and can have nan values replace them with ''
        purchase_previous_new_dataframe[["Vendor Name"]] = purchase_previous_new_dataframe[["Vendor Name"]].fillna(
            '').astype(str, errors='ignore')

        # Gr amount in loc cur & Unit price - float datatype and can have nan values, replace them with 0
        purchase_previous_new_dataframe[["GR Amt.in loc.cur.", "Unit Price", "GR Qty"]] = \
        purchase_previous_new_dataframe[
            ["GR Amt.in loc.cur.", "Unit Price", "GR Qty"]].fillna(0).astype(float, errors='ignore')

        # print(purchase_previous_new_dataframe.dtypes.tolist())
    ...
    try:
        with pd.ExcelWriter(filtered_sales_previous_file_saving_path, engine="openpyxl") as writer:
            purchase_previous_new_dataframe.to_excel(writer, sheet_name=filtered_sales_previous_sheet_name,
                                                     index=False)
