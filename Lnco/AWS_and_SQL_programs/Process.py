...
def audit_process(host, username, password, database, aws_bucket_name, aws_access_key, aws_secret_key,
    ...
    try:
        ...
        print(in_progress_status_keyword)
        ...
        print(success_request_status_keyword)
        ...
        print(fail_request_status_keyword)
        ...
        logging.warning(
            "Status value keywords are not found or corrupt in env file, setting up default values: " + '\n\t' +
    ...
    if len(audit_requests_in_progress) > 0:
        ...
        send_mail_reusable_task.send_mail(to_in_progress_request_found, cc_in_progress_request_found,
